...
// We will find the FIRST occurrence of export const clientProjectsData
const startIndex = data.indexOf('export const clientProjectsData');
if (startIndex !== -1) {
  data = data.slice(0, startIndex);
  data += `export const clientProjectsData: any[] = [
  { 
    id: 'cp1', 
