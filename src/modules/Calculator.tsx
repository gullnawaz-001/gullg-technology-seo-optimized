...
export function Calculator({ onNavigate }: { onNavigate?: (view: ViewState) => void }) {
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="mt-auto pt-6 border-t border-slate-100 flex flex-col gap-4">
                ...
                <button
                  onClick={() => onNavigate && onNavigate('client-portal')}
                  className="w-full text-center mt-2 text-sm font-bold text-slate-500 hover:text-slate-900 underline transition-colors"
                >
                  Submit Your Offer
                </button>
              </div>
